---
id: preparing-for-recruiting
title: Preparing for PE Recruiting
order: 6
...
Preparation for PE recruiting is not something you can compress into a few weeks before interviews begin. The candidates who succeed are those who prepare systematically over months, building technical skills, cultivating relationships, and developing genuine insight into the industry. This lesson provides a framework for that preparation.
...
Relationship cultivation means building connections with PE professionals, headhunters, and others who can provide access and insight. Recruiting is a relationship-driven process, and candidates without relationships operate at a significant disadvantage.

## Technical Preparation: Depth Over Breadth

Technical preparation should prioritize depth over breadth. PE interviews test whether you can actually execute, not whether you can recite formulas. An interviewer who asks about LBO mechanics wants to see you think through the components, handle edge cases, and demonstrate comfort with the material.

LBO modeling is the core technical skill. You should be able to build an LBO model from scratch, understand each component (sources and uses, debt schedules, cash flow projections, returns analysis), and discuss the drivers of returns. Practice until you can build a basic LBO model quickly and accurately under pressure.

Beyond the mechanics, develop intuition about what drives LBO returns. How does entry multiple affect returns? What is the impact of leverage? How do operational improvements compound over time? These questions reveal whether you understand the investment logic, not just the spreadsheet.
...
## Narrative Development: Authenticity and Specificity

Your narrative must answer the fundamental questions every interviewer asks, explicitly or implicitly: Why PE? Why now? Why this firm? Why should we hire you?

The "why PE" answer should reflect genuine motivation, not generic ambition. What specifically attracts you to private equity? Perhaps it is the ownership mindset, the longer-term investment horizon, the combination of financial analysis and operational involvement, or the exposure to decision-making at the highest levels. Whatever your reasons, they should be authentic and specific.

The "why now" question addresses timing. Why are you recruiting at this point in your career? This is especially relevant for on-cycle candidates with limited experience. Demonstrate that you understand the recruiting dynamics and have made a deliberate decision, not that you are simply following the herd.
...
Headhunter relationships are also investments. A headhunter who knows you well will present you more effectively to firms. Take initial headhunter conversations seriously, follow up thoughtfully, and maintain communication over time.
...
Preparation should begin as early as possible, ideally when you start banking. The technical skills and relationships you build from day one compound over time.

During your first six months, focus on foundational technical skills and initial relationship building. Build basic LBO competence, reach out to network connections, and begin understanding the PE landscape.

From months six to twelve, intensify technical preparation and headhunter engagement. Refine your modeling skills to interview-ready levels. Connect with headhunters and begin positioning yourself for the cycle.

In the weeks before interviews, focus on polish. Practice modeling tests under time pressure. Rehearse narratives until they are natural. Review your deal experiences so you can discuss them fluently.

Throughout this process, continue performing well in banking. Your work performance is a signal that firms and headhunters observe. Strong performance creates momentum; weak performance raises concerns.
