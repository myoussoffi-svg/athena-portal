...
**At opco**: Senior secured debt (term loans, revolver), secured by the operating assets and cash flows of the business. This is the lowest-risk debt in the structure, priced accordingly at typically SOFR plus 400-600 basis points depending on credit quality. Opco lenders have first claim on operating cash flow and assets.

**At holdco**: Holdco notes or PIK facilities, structurally subordinated to all opco debt. Holdco debt has no direct claim on opco assets or cash flows. Its recovery depends entirely on the residual equity value of opco after opco debt is satisfied. This structural subordination commands a significant premium, and holdco debt typically prices at 10-14% all-in, often with substantial PIK components.
