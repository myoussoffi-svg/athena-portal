      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '32px 24px' }}>
        {pageState === 'upload' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            >
              ...
              <div>
                ...
                <ol style={{ margin: 0, paddingLeft: 20, color: 'rgba(10, 10, 10, 0.6)', fontSize: 14, lineHeight: 1.7 }}>
                  ...
                  <li>Our AI analyzes it against {trackSlug === 'private-equity-interview-prep' ? 'PE recruiting standards' : 'Investment Banking standards'}</li>
            ...
            {/* Example Resume Section - only for IB (PE users already have banking resumes) */}
