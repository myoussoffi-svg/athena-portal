---
id: walking-through-resume
title: Walking Through Your Resume
order: 2
...
- Explain each resume item clearly and concisely when asked to elaborate
- Anticipate which experiences interviewers will probe and prepare detailed responses
- Defend gaps, transitions, or unusual choices on your resume with coherent rationale
- Structure responses to resume questions to emphasize skills relevant to banking
...
When asked about a specific role or project, use a clear structure:

1. **Context**: What was the organization, your role, and the objective?
2. **Your contribution**: What did you specifically do? (Avoid "we" unless necessary; focus on "I")
3. **Outcome or learning**: What was the result, or what skill did you develop?

For example, if asked about a finance internship:
...
- "How did you approach [specific task]?"
...
**Switch from non-finance background**: "I studied engineering, but through a summer internship in corporate development, I realized I preferred the deal-focused, client-facing aspects of finance. That's what led me to recruit for banking."

**Unrelated internship or job**: "I worked in marketing for six months after graduation. While I learned a lot about client management, I realized I wanted a more analytical, transaction-focused role, which is why I'm pursuing banking."

The key is to show that your path makes sense and that you've thought critically about your decisions.
