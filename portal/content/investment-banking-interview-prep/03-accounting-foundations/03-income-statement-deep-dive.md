...
- Explain each major line item on the income statement and what it represents
- Understand the difference between gross profit, operating income (EBIT), and net income
- Identify common adjustments and non-recurring items that affect income statement analysis
- Evaluate why EBIT and EBITDA are often used in valuation instead of net income
...
The income statement follows a cascading structure, starting with revenue and subtracting various categories of expenses to arrive at net income.
...
- **Depreciation and Amortization (D&A)**: Non-cash expenses representing the allocation of the cost of long-lived assets over time

**Operating Income (EBIT)**:
Operating Income (also called **EBIT**, or Earnings Before Interest and Taxes) is:
...
This is income before accounting for taxes.

**Income Tax Expense**:
Taxes are calculated based on pre-tax income and the applicable tax rate. The effective tax rate may differ from the statutory rate due to deductions, credits, or international tax structures.
...
### Common Adjustments and Non-Recurring Items

Income statements often include one-time or non-recurring items that distort true operating performance. When analyzing a company or building a model, you may need to adjust for:

- **Restructuring charges**: Costs related to layoffs, facility closures, or reorganizations
- **Asset impairments or write-downs**: Reducing the value of assets that are no longer worth their book value
- **Gains or losses on asset sales**: Selling a division or property may create a one-time gain or loss
- **Litigation settlements**: Large legal expenses or settlements

Bankers often calculate **adjusted EBITDA** or **normalized EBITDA** by removing these items to reflect sustainable, ongoing profitability.

### Common Mistakes

**Confusing revenue with cash received**: Revenue is recognized when earned (accrual basis), not when cash is collected. This distinction matters when linking to the cash flow statement.
